...
/*function afficherLesNotfications(){
  var arr = JSON.parse(localStorage.getItem("BDnotification"));                
  var k = 0;
...
function count(){
  chargerTable(13,"BDnotification");
  var arr = JSON.parse(localStorage.getItem("BDnotification"));                
    var k = 0;
...
function inbox(){
	var arr2 = JSON.parse(localStorage.getItem("BDnotification"));
  var split = [];                
...
function sent(){
	var arr3 = JSON.parse(localStorage.getItem("BDnotification")); 
  var split = [];               
...
function draft(){
	var arr4 = JSON.parse(localStorage.getItem("BDnotification"));                
  var split = [];
...
function spam(){
	var arr5 = JSON.parse(localStorage.getItem("BDnotification"));                
  var split = [];
...
function archive(){
	var arr6 = JSON.parse(localStorage.getItem("BDnotification"));                
  var split = [];
